...
import {RPC_URL, ERC20_ABI, STAKING_REWARDS_ABI, HONEY_ADDRESS, PAIR_ABI} from '../constants';
...
export async function getHONEYBalance(address: string) {
  return getBalance(HONEY_ADDRESS, address);
}
